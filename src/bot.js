...
let queryString = ura(strings.queryString)
let queryStringSubQuery = ura(strings.queryStringSubQuery)
let result = ura(strings.resultType)
let response = ura(strings.responseString)
...
function tweetAText () {
  ...
  var tweetTxt = "BOT: ID:"+id+" twitando a cada "+seconds+" segundos"
  id++
  var tweet = {
    status: tweetTxt
  }
...
var miliseconds = 60000
tweetAText()
setInterval(tweetAText, miliseconds)